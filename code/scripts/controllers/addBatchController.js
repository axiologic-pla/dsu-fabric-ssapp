...
export default class addBatchController extends ContainerController {
    constructor(element, history) {
        ...
        this.on("add-batch", () => {
            ...
            this.DSUStorage.getItem(constants.BATCHES_STORAGE_PATH, "json", (err, batches) => {
    ...
    persistBatch(batch, callback) {
        this.DSUStorage.getItem(constants.BATCHES_STORAGE_PATH, 'json', (err, batches) => {
            ...
            batches.push(batch);
            this.DSUStorage.setItem(constants.BATCHES_STORAGE_PATH, JSON.stringify(batches), callback);
        });
    }
