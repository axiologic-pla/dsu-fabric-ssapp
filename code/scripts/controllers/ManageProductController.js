...
export default class ManageProductController extends ContainerController {
    ...
    persistProduct(product, callback) {
        ...
        this.DSUStorage.setItem(constants.PRODUCTS_STORAGE_PATH, JSON.stringify(this.products), callback);
    }
    ...
    persistKeySSI(keySSI, gtin, callback) {
        this.DSUStorage.getItem(constants.PRODUCT_KEYSSI_STORAGE_PATH, "json", (err, keySSIs) => {
            ...
            keySSIs[gtin] = keySSI;
            this.DSUStorage.setItem(constants.PRODUCT_KEYSSI_STORAGE_PATH, JSON.stringify(keySSIs), callback);
        });
    }
